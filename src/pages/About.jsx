    ...
    <div className="container">
      ...
      <div className="row align-items-center">
        ...
        <div className="col-12 col-md-8 px-3 text-center text-md-start">
          ...
          <p className="regular-text text-justify">I incorporate AI extensively to accelerate my development delivery, but never at the expense of fully understanding the technologies, processes and functionalities in place. I do not believe that AI is here to replace our professions — but to evolve them instead. As the landscape shifts, I believe that remaining agile and adaptable is the key in remaining thriving and relevant.</p>
